...
import com.gym.training.user.controller.response.ErrorResponse;
...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleDuplicateUserProfile(DuplicateUserProfileException exception, HttpServletRequest request) {
